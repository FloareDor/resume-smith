  ...
  return (
    <div>
      <div className="flex flex-col gap-6 items-center px-[6.5%]">
        ...
        <button className="rounded-full outline-2 outline outline-gray-300 w-5/6 md:w-4/6 lg:w-2/6 px-10 py-2">
		...
		<div className="relative flex flex-row items-center w-5/6 md:w-4/6 lg:w-2/6">
		...
		<div className="flex flex-col items-center gap-1 w-5/6 md:w-4/6 lg:w-2/6">
			...
			<span className="text-black text-sm">By continuing, you agree to the Terms of use and Privacy Policy.</span>	  
			  ...
			  <div className="flex flex-row items-center justify-between w-5/6 md:w-4/6 lg:w-2/6">
